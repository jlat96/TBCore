...
{
    /// <summary>
    /// RandomRestartHillClimber is a HillClimber optimizer that runs a Climber operation many times.
    /// </summary>
    ...
    public class RandomRestartHillClimber<TState, TEvaluation> : IterableHillClimber<TState, TEvaluation>
